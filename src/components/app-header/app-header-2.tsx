...
import { View, StyleSheet, Image, Text, TouchableOpacity, SafeAreaView, ScrollView, Pressable, Platform, TextInput, FlatList } from 'react-native';
    ...
    return (
        <>
            <View style={styles.container}>
                ...
                <Pressable
                    onPress={() => { isBack ? navigation.goBack() : navigation.openDrawer() }}
                    style={styles.leftIcon}
                >
                    <AppIcon
                        //  icon={IconNames.MENU}
                        icon={isBack ? IconNames.ARROWLEFT : IconNames.MENU}
                        size={15} containerStyle={{ paddingHorizontal: 10 }} />
                </Pressable>
                ...
                <Pressable style={styles.rightIcon} >
                    ...
                    <AppIcon icon={IconNames.NOTIFICATION}
                        size={25}
                        containerStyle={{
                            paddingHorizontal: 5
                        }} />
                    ...
                    <TouchableOpacity onPress={() => showProfile()}>
                        <AppIcon icon={IconNames.PROFILE}
                            size={15}
                            containerStyle={{
                                paddingHorizontal: 5
                            }} /> 
