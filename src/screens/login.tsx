...
const LoginScreen = () => {
  ...
  useEffect(() => {
    GoogleSignin.configure({
      webClientId: '572081542122-8vdel6co008r20475qri1dkul2l45ja3.apps.googleusercontent.com',
    });
  }, []);
  ...
  return (
    <ImageBackground source={require("../assets/images/backgroundimg.png")} style={styles.backgroundimg}>
      <View style={styles.container}>
        ...
        <TouchableOpacity style={{ marginBottom: 22 }} onPress={signInWithGoogle}>
          <AppIcon icon={IconNames.GOOGLE_LOGIN} size={20} />
        </TouchableOpacity>

        {Platform.OS === 'ios' && (
          <TouchableOpacity
            onPress={() => { /* Implement Apple login logic here if needed */ }}
